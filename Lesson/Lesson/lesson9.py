...
""" Function
    ...
    - Các kiểu của function
    - Tham số (Đối số) của function
    - Anonymous function
    - Lập trình cấu trúc
"""
...
def min_diff(a, b, c):
    """ Hàm tìm ra khoảng cách nhỏ nhất giữa 2 trong 3 số a, b, c
    """
    diff_ab = abs(a - b)
    diff_bc = abs(b - c)
    diff_ca = abs(c - a)
    return min(diff_ab, diff_bc, diff_ca)


print(min_diff(1, -5, 5))
print(min_diff(100, 10, 1))
print(min_diff(0, 1, 2))
...
""" Làm ví dụ:
    - Xây dựng hàm tính trị tuyệt của một số
    - Dùng hàm abs() để tính trị tuyệt đối của một số
"""
...
""" Lập trình cấu trúc 
    - Hay còn gọi là lập trình hướng thủ tục (Procedure Oriented Programming -- POP)
    - Là một kỹ thuật lập trình truyền thống, trong đó chương trình được chia thành các hàm (chương trình con) 
...
"""
""" Ví dụ: 
    Chương trình nhập và hiển thị thông tin người dùng sẽ chia thành hai chương trình con là chương trình nhập và xuất, 
    nếu việc nhập thông tin phức tạp thì chương trình nhập thông tin có thể chia ra nhiều chương trình con khác nhau.
"""

""" Tạo mô-đun riêng của mình 
Yêu cầu: Lập trình để giải quyết công việc sau
    - Nhập một số nguyên dương N (0 < N < 200) từ bàn phím
